...
public class Steps 
{
	...
	public void setUP()
	{
		...
		System.setProperty("webdriver.chrome.driver", "/Users/madanmohanreddy/Desktop/gitrepository/cucumber-report/drivers/chromedriver");
...
public void i_enter_the_intermediate_Percentage() throws InterruptedException {
		...
		Static login = new Static(driver);
		login.Intermediate_Percentage("intermediate");
